...
## Project Structure
    ...
    ├── sitter_scheduler_38331  # Django project configurations
...
1. Clone this repo and `cd sitter_scheduler_38331`
...
2. Clone this repo and `cd sitter_scheduler_38331`
