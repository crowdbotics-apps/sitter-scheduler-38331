"""
Django settings for sitter_scheduler_38331 project.
...
ROOT_URLCONF = 'sitter_scheduler_38331.urls'
...
WSGI_APPLICATION = 'sitter_scheduler_38331.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sitter_scheduler_38331 API",
    "DESCRIPTION": "API documentation for sitter_scheduler_38331 App",
    "VERSION": "v1",
}
